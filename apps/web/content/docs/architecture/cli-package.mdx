---
title: CLI Package
description: Scaffolding CLI. Downloads, renames, and configures Catalyzer projects.
icon: Terminal
---
...
Published to npm as [`create-catalyzer`](https://www.npmjs.com/package/create-catalyzer). Downloads the latest source, renames all identifiers to match your project, configures Android and iOS packaging, inits git, and optionally installs dependencies.
...
This ensures the scaffolded project starts with a clean documentation structure instead of the Catalyzer source docs.
...
|---|---|
| `com.catalyzer.app` | User's app identifier |
| `catalyzer_lib` | `<project_name_snake>_lib` |
| `Catalyzer` | PascalCase project name |
| `odest` | User's GitHub username |
| `catalyzer` | User's project name |
