...
export function AppHeader({ pathname, LinkComponent = "a" }: AppHeaderProps) {
  ...
  return (
    <header className="group-has-data-[collapsible=icon]/sidebar-wrapper:h-12 hidden md:flex h-12 shrink-0 items-center gap-2 border-b transition-[width,height] ease-linear">
