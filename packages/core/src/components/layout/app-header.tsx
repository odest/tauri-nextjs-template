...
export function AppHeader({ pathname, LinkComponent = "a" }: AppHeaderProps) {
  ...
  return (
    <header className="hidden h-(--comp-h-12) shrink-0 items-center gap-2 border-b transition-[width,height] ease-linear group-has-data-[collapsible=icon]/sidebar-wrapper:h-(--comp-h-12) md:flex">
